...
- 生成后清理 MVP：可将选中的颜色全局设为 ignored background，或合并到另一个当前图纸已有颜色；支持撤销上一步清理编辑；有已编辑状态提示与全局操作风险提示；预览、材料统计和 PNG 导出使用当前编辑后的图纸，且可重置回原始生成结果
...
## 近期阶段状态
- 当前稳定提交：`687c8d5 chore: polish cleanup edit UX`
...
## 当前下一步路线
1. 暂不启动 Phase 4K-5；候选方向仅包括 autosave edited pattern、export/material QA polish、local erase / restore、edit history polish
